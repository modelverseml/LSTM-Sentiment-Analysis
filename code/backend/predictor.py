...
glove, bert) and run all THREE trained models (the PyTorch LSTM, the TensorFlow
SimpleRNN, and the from-scratch NumPy LSTM) for that encoder, returning the
...
from model_artifacts_generation import (  # noqa: E402
    LSTMTorch, HIDDEN_DIM, NUM_LAYERS, DROPOUT, NUM_CLASSES, ARTIFACT_ROOT,
)
from manual_lstm import ManualLSTM  # noqa: E402

# alias so the rest of this file stays architecture-agnostic
TorchModel = LSTMTorch
ManualModel = ManualLSTM
...
_manual_models = {}  # encoder -> ManualLSTM
